...
import ConsoleGame.data.Heroes.HeroArmor.entities.MediumArmor
...
import ConsoleGame.data.Heroes.HeroWeapons.entities.Daggers

class Robber(
    override var attack: Int = Daggers().getHeroAttack(),
    override var defense: Int = MediumArmor().getArmorDefense(),
    override var health: Int = HeroHealthImpl(HeroHealthImpl.ROBBER_HEALTH).getHeroHealth()
) : Heroes() {
